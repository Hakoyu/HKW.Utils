...
internal static partial class EnumerableHelpers
{
    ...
    internal static void Reset<T>(ref T enumerator)
        where T : IEnumerator => enumerator.Reset();

    /// <summary>Gets an enumerator singleton for an empty collection.</summary>
    internal static IEnumerator<T> GetEmptyEnumerator<T>() => ((IEnumerable<T>)[]).GetEnumerator();
