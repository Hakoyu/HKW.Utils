...
//    private readonly Dictionary<TKey, TReadOnlyValue> _readOnlyDictionary;
...
//        _readOnlyDictionary = _dictionary.ToDictionary(
//            kv => kv.Key,
//            kv => (TReadOnlyValue)kv.Value
//        );
//    }
...
//    {
//        var reslut = _dictionary.TryGetValue(key, out var sourceValue);
//        value = sourceValue;
//        return reslut;
//    }
...
//    {
//        ((ICollection<KeyValuePair<TKey, TReadOnlyValue>>)_dictionary).CopyTo(array, arrayIndex);
//    }
